...
* The original package name 'com.madushan.Gem Auction' is invalid and this project uses 'com.madushan.Gem.Auction' instead.
...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/docs/3.1.7/reference/html/actuator.html#actuator.micrometer-tracing.getting-started)
